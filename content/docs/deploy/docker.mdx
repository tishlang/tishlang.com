...
A minimal Node HTTP image plus `tish.yaml` lives in [tish-container-example](https://github.com/tishlang/tish-container-example).

## Full reference

Volumes, API payloads, and operator details: [Container deployments](https://github.com/tishlang/zectre-platform/blob/main/docs/CONTAINER_DEPLOYMENTS.md) in the zectre-platform repository.
