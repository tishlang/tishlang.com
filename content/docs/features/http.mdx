...
Requires the `http` feature. Build tish with it for run: `cargo run -p tishlang--features http -- run main.tish`. For compile: `tish compile main.tish -o app --feature http`.
