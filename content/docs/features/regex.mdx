...
Requires the `regex` feature. Build tish with it for run: `cargo run -p tishlang--features regex -- run main.tish`. For compile: `tish compile main.tish -o app --feature regex`.
